...
public class TestCountPrimesTasks {
    ...
    public static void main(String[] args) {
        ...
        for (int nrOfTasks = 1; nrOfTasks <= 12; nrOfTasks++) {
            int currentNrOfTasks = nrOfTasks;
            System.out.println(Mark7(String.format("countParTask1 %6d", nrOfTasks),
                    i -> countParallelN1(range, currentNrOfTasks)));
        }
    }
