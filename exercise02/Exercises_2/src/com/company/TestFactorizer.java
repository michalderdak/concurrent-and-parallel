...
class TestFactorizer {
    public static void main(String[] args) {
        ...
        final FactorizerOld factorizer = new VolatileCachingFactorizer();
...
// Like Goetz p. 18
class StatelessFactorizer implements FactorizerOld {
    public long[] getFactors(long p) {
...
class UnsafeCountingFactorizer implements FactorizerOld {
...
// Like Goetz p. 23
class CountingFactorizer implements FactorizerOld {
...
class UnsafeCachingFactorizer implements FactorizerOld {
...
class TooSynchronizedCachingFactorizer implements FactorizerOld {
...
// Like Goetz p. 31.
class CachingFactorizer implements FactorizerOld {
    private long lastNumber = 1;
    private long[] lastFactors = new long[]{1};
...
// Like Goetz p. 50.
class VolatileCachingFactorizer implements FactorizerOld {
